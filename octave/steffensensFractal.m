...
% Purpose: Create a Steffensen's Method Convergence %
%       diagram for any function whose roots are    %
%       known (up to 12 of them)                    %
% INPUT: function f; a list of roots of f; real     %
%       lower bound r0; real upper bound r1;        %
%       imaginary center im; size sz of             %
%	image to create (will be multiplied by 8).  %
% OUTPUT: matrix of roots found; fractal image.     %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

function res = steffensensFractal(f,roots,r0,r1,im,sz)
