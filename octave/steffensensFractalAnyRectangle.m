...
% Purpose: Create a Steffensen's Fractal for any    %
% function whose roots are known (up to 12 of them) %
...
function res = steffensensFractalAnyRectangle(f,roots,r0,r1,i0,i1,sz)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Run Steffensen's Method for each p0 in the grid
...
for i=1:columns(p0)
  for j=1:rows(p0)
    [z,k]=steffensens(f,p0(j,i),10^-7,maxits);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
imshow(res,map);
imwrite(res,map,"steffensensFractal.png");
